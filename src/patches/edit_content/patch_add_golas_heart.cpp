...
void PatchAddGolasHeart::inject_code(md::ROM& rom, World& world)
{
    ...
    // Giant stairs
    Map* gh_room_10 = add_gh_stairs_room(rom, world, golas_heart_palette, MAP_GOLAS_HEART_STAIRS_1);
    world.map_connections().emplace_back(MapConnection(gh_room_9->id(), 16, 51, gh_room_10->id(), 45, 22, 4));
    Map* gh_room_11 = add_gh_stairs_room(rom, world, stairs_palette_1, MAP_GOLAS_HEART_STAIRS_2);
    world.map_connections().emplace_back(MapConnection(gh_room_10->id(), 20, 22, gh_room_11->id(), 45, 22, 4));
    Map* gh_room_12 = add_gh_stairs_room(rom, world, stairs_palette_2, MAP_GOLAS_HEART_STAIRS_3);
