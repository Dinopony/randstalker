...
void alterGameStart(md::ROM& rom, const RandomizerOptions& options, const World& world)
{
    ...
    // ------- Set spawn position ---------
    rom.setWord(0x0027F4, world.active_spawn_location()->map_id());
    rom.setByte(0x0027FD, world.active_spawn_location()->position_x());
    rom.setByte(0x002805, world.active_spawn_location()->position_y());
