...
constexpr uint16_t MAP_RYUMA_RAFT_PIER = 183;
...
constexpr uint16_t MAP_ROUTE_TO_RYUMA_1 = 438;
constexpr uint16_t MAP_ROUTE_TO_RYUMA_2 = 439;
constexpr uint16_t MAP_440 = 440;
constexpr uint16_t MAP_HELGAS_HUT_EXTERIOR = 441;
...
constexpr uint16_t MAP_HELGAS_HUT = 480;
constexpr uint16_t MAP_481 = 481;
constexpr uint16_t MAP_482 = 482;
constexpr uint16_t MAP_ROUTE_AFTER_DESTEL_1 = 483;
constexpr uint16_t MAP_484 = 484;
constexpr uint16_t MAP_485 = 485;
constexpr uint16_t MAP_486 = 486;
constexpr uint16_t MAP_487 = 487;
constexpr uint16_t MAP_ROUTE_AFTER_DESTEL_2 = 488;
constexpr uint16_t MAP_ROUTE_AFTER_DESTEL_BOATMAN_HOUSE_ACCESS = 489;
constexpr uint16_t MAP_ROUTE_AFTER_DESTEL_3 = 490;
constexpr uint16_t MAP_ROUTE_AFTER_DESTEL_BOATMAN_HOUSE = 491;
...
constexpr uint16_t MAP_ROUTE_AFTER_DESTEL_VANTAGE_POINT = 525;
...
constexpr uint16_t MAP_TIBOR = 533;
constexpr uint16_t MAP_TIBOR_TREE_NEAR_TIBOR = 534;
...
constexpr uint16_t MAP_RYUMA_LIGHTHOUSE_STAIRS_0F = 612;
...
constexpr uint16_t MAP_RYUMA_MIDDLE_HOUSE = 620;
constexpr uint16_t MAP_RYUMA_MIDDLE_HOUSE_VARIANT = 621;
constexpr uint16_t MAP_622 = 622;
constexpr uint16_t MAP_623 = 623;
constexpr uint16_t MAP_RYUMA_INN = 624;
constexpr uint16_t MAP_RYUMA_LIGHTHOUSE_STAIRS_1F = 625;
constexpr uint16_t MAP_RYUMA_LIGHTHOUSE_STAIRS_2F = 626;
constexpr uint16_t MAP_RYUMA_LIGHTHOUSE = 627;
constexpr uint16_t MAP_RYUMA_LIGHTHOUSE_BROKEN = 628;
constexpr uint16_t MAP_RYUMA_LIGHTHOUSE_REPAIRED = 629;
...
constexpr uint16_t MAP_DESTEL_EXTERIOR = 726;
